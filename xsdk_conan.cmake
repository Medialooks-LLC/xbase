        ...
        if(CMAKE_MSVC_RUNTIME_LIBRARY)
            ...
            if(NOT CMAKE_MSVC_RUNTIME_LIBRARY MATCHES "<CONFIG:Debug>:Debug>")
                if(CMAKE_MSVC_RUNTIME_LIBRARY MATCHES "Debug")
                    ...
                    set(_COMPILER_RUNTIME_TYPE "RelWithDebInfo")
                endif()
            endif()
...
macro(conan_provide_dependency method package_name)
    ...
    if(NOT _conan_install_success)
        ...
        if(NOT _multiconfig_generator)
            ...
            conan_install(${_host_profile_flags} ${_build_profile_flags} -s build_type=${CMAKE_BUILD_TYPE} --build=missing ${generator})
        else()
            message(STATUS "CMake-Conan: Installing both Debug and RelWithDebInfo")
            conan_install(${_host_profile_flags} ${_build_profile_flags} -s build_type=RelWithDebInfo --build=missing ${generator})
