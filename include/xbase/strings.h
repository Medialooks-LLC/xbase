...
/// @endcode
XBASE_API std::string Format(const char* _format_psz, ...);

XBASE_API std::string Escape(const std::string& _text, bool _escape);
...
XBASE_API std::string_view Trim(std::string_view _text, std::string_view _trim_chars = kDefaultTrimChars);
...
/// Split(",a,,b,", ',') -> ["", "a", "", "b", ""]
/// @endcode
XBASE_API std::vector<std::string_view> Split(std::string_view _text,
                                              char             _sep,
...
/// @param _drop_empty If true, empty tokens are removed (after optional trimming).
/// @return Vector of tokens (string_view) referencing `_text`.
XBASE_API std::vector<std::string_view> SplitAny(std::string_view _text,
...
XBASE_API std::vector<std::string_view> SplitExact(std::string_view _text,
                                                   std::string_view _delim,
                                                   bool             _trim_entries = false,
                                                   bool             _drop_empty   = false);

XBASE_API std::vector<std::string> SplitCopy(std::string_view _text, char _sep, bool _trim_entries = false);

XBASE_API std::vector<std::string> SplitAnyCopy(std::string_view _text,
                                                std::string_view _delim,
                                                bool             _trim_entries = false);

XBASE_API std::vector<std::string> SplitExactCopy(std::string_view _text,
                                                  std::string_view _delim,
                                                  bool             _keep_delim = false);
...
/// @endcode
XBASE_API std::string SnakeCase(std::string_view _text);
...
XBASE_API int32_t CmpI(std::string_view _str_left, std::string_view _str_right);
...
/// @return 0 if equal; <0 if left < right; >0 otherwise.
XBASE_API int32_t Cmp(std::string_view _str_left, std::string_view _str_right, bool _case_sensitive);
...
XBASE_API size_t Find(std::string_view _text, std::string_view _str_find, bool _case_sensitive, size_t _offset);
...
XBASE_API bool IsPrefix(std::string_view _text, std::string_view _prefix, std::string* _wo_prefix_p);

/// @brief Convenience overload for IsPrefix().
/// @param _text Input text.
/// @param _prefix Prefix to check.
/// @return Pair {matched, remainder}.
XBASE_API std::pair<bool, std::string> IsPrefix(std::string_view _text, std::string_view _prefix);
...
XBASE_API bool IsPostfix(std::string_view _text, std::string_view _postfix, std::string* _wo_postfix_p);

/// @brief Convenience overload for IsPostfix().
/// @param _text Input text.
/// @param _postfix Postfix to check.
/// @return Pair {matched, remainder}.
XBASE_API std::pair<bool, std::string> IsPostfix(std::string_view _text, std::string_view _postfix);

XBASE_API std::string Replace(const std::string& _text,
                              const std::string& _from,
                              const std::string& _to,
                              size_t*            _replaced_p);

XBASE_API size_t Replace(std::string& _text, const std::string& _from, const std::string& _to);
...
/// Join({"a","","b"}, false, ",") -> "a,,b"
/// @endcode
XBASE_API std::string Join(const std::vector<std::string_view>& _parts,
                           bool                                _drop_empty,
                           std::string_view                    _delimiter = {});

XBASE_API std::string Join(const std::vector<std::string>& _parts,
                           bool                            _drop_empty,
                           std::string_view                _delimiter = {});
...
XBASE_API bool SaveFile(std::string_view        _text,
                        std::string_view        _filename,
                        std::ios_base::openmode _mode    = std::ios_base::out,
                        std::string*            _error_p = nullptr);

XBASE_API std::string LoadFile(std::string_view        _filename,
